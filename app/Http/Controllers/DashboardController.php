...
class DashboardController extends Controller
{
    ...
    {
        return view('pipeline', ['agents' => config('agents.agents', [])]);
    }
    ...
    public function socialInstagramRedirect(): RedirectResponse
    {
    ...
    public function socialInstagramCallback(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $profile = Http::get('https://graph.instagram.com/me', [
                'fields' => 'id,username',
    ...
    public function socialTwitterRedirect(Request $request): RedirectResponse
    {
    ...
    public function socialTwitterCallback(Request $request): RedirectResponse
    {
        if ($request->has('error')) {
    ...
    public function socialLinkedInRedirect(): RedirectResponse
    {
    ...
    public function socialLinkedInCallback(Request $request): RedirectResponse
    {
        if ($request->has('error')) {
        ...
        try {
            ...
            $orgsResponse = Http::withToken($tokenData['access_token'])
                ->withHeaders(['X-Restli-Protocol-Version' => '2.0.0'])
    ...
    public function socialFacebookRedirect(): RedirectResponse
    {
    ...
    public function socialFacebookCallback(Request $request): RedirectResponse
    {
        if ($request->has('error')) {
    ...
    public function socialTikTokRedirect(Request $request): RedirectResponse
    {
    ...
    public function socialTikTokCallback(Request $request): RedirectResponse
    {
        if ($request->has('error')) {
    ...
    public function socialYouTubeRedirect(): RedirectResponse
    {
    ...
    public function socialYouTubeCallback(Request $request): RedirectResponse
    {
        if ($request->has('error')) {
        ...
        try {
            $tokenData = $svc->exchangeCode($request->get('code'));
            // Fetch channel info
            $channel = Http::withToken($tokenData['access_token'])
    ...
    public function apiCreateCalendarEntry(Request $request): JsonResponse
    {
        ...
        if (! empty($validated['scheduled_at'])) {
            $time = Carbon::parse($validated['scheduled_at']);
    ...
    public function apiTrendInsights(Request $request): JsonResponse
    {
        ...
        $insights = Cache::remember($cacheKey, 900, function () use ($platform) {
            ...
            if ($platform !== 'all') {
                $query->where(function ($q) use ($platform, $like) {
