...
class ContextGraphNode extends Model
{
    ...
    public function outEdges()
    {
        return $this->hasMany(ContextGraphEdge::class, 'source_node_id');
    }

    public function inEdges()
    {
        return $this->hasMany(ContextGraphEdge::class, 'target_node_id');
    }

    public static function semanticSearch(array $embedding, int $topK = 10, ?string $type = null, ?string $category = null): Collection
    {
