...
<head>
    ...
    <style>
        /* ── Autonomous Ops Platform — Horizon Theme Override ─────────────── */
        /* Matches: bg-slate-950, bg-slate-900, brand-violet palette from app.blade.php */
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .nav-link:hover,
        .nav-link.active {
            background-color: rgba(124, 58, 237, 0.2) !important; /* brand-600/20 */
            color: #a78bfa !important; /* brand-400 */
        ...
        /* ── Header / Logo ────────────────────────────────────────────────── */
        .header { border-bottom: 1px solid #1e293b !important; }
        .header h1, .header .h4 { color: #f1f5f9 !important; font-size: 1rem !important; font-weight: 600 !important; }
        .header strong { color: #a78bfa !important; } /* brand-400 */
        .fill-primary { fill: #8b5cf6 !important; } /* brand-500 */
        ...
        /* ── Tables ────────────────────────────────────────────────────────  */
        .table { color: #cbd5e1 !important; font-size: 0.8125rem !important; }
        .table th { color: #64748b !important; font-weight: 600 !important; text-transform: uppercase; font-size: 0.7rem !important; letter-spacing: 0.05em; border-bottom: 1px solid #1e293b !important; }
        .table td { border-bottom: 1px solid #1e293b !important; vertical-align: middle; }
        .table-hover tbody tr:hover { background-color: rgba(30, 41, 59, 0.6) !important; }
        .table-striped tbody tr:nth-of-type(odd) { background-color: rgba(15, 23, 42, 0.4) !important; }

        /* ── Buttons ───────────────────────────────────────────────────────  */
        .btn-primary, .bg-primary {
            background-color: #7c3aed !important; /* brand-600 */
            border-color: #7c3aed !important;
            color: #fff !important;
        }
        .btn-primary:hover { background-color: #6d28d9 !important; border-color: #6d28d9 !important; }
        .btn-muted, .btn-outline-secondary {
            background-color: transparent !important;
            border-color: #334155 !important;
            color: #94a3b8 !important;
        }
        .btn-muted:hover { background-color: #1e293b !important; color: #e2e8f0 !important; }
        .btn-muted.active { background-color: rgba(124, 58, 237, 0.2) !important; color: #a78bfa !important; border-color: rgba(139, 92, 246, 0.4) !important; }

        /* ── Badges / status ──────────────────────────────────────────────  */
        .badge { font-size: 0.7rem !important; font-weight: 500 !important; padding: 0.25rem 0.5rem !important; border-radius: 0.375rem !important; }
        .badge-success, .bg-success { background-color: rgba(52, 211, 153, 0.2) !important; color: #34d399 !important; }
        .badge-danger,  .bg-danger  { background-color: rgba(248, 113, 113, 0.2) !important; color: #f87171 !important; }
        .badge-warning, .bg-warning { background-color: rgba(251, 191, 36, 0.2)  !important; color: #fbbf24 !important; }
        .badge-info,    .bg-info    { background-color: rgba(96, 165, 250, 0.2)  !important; color: #60a5fa !important; }
        ...
        .alert-danger  { background-color: rgba(248, 113, 113, 0.1) !important; border-color: rgba(248, 113, 113, 0.3) !important; color: #f87171 !important; }
        ...
        /* ── Pagination ────────────────────────────────────────────────────  */
        .page-link { background-color: #1e293b !important; border-color: #334155 !important; color: #94a3b8 !important; }
        .page-link:hover { background-color: #334155 !important; color: #e2e8f0 !important; }
        .page-item.active .page-link { background-color: #7c3aed !important; border-color: #7c3aed !important; color: #fff !important; }
        .page-item.disabled .page-link { background-color: #0f172a !important; color: #475569 !important; }
        ...
        pre, code { background-color: #0f172a !important; color: #a78bfa !important; border-radius: 0.375rem; padding: 0.1rem 0.3rem; }

        /* ── Scheme toggler ────────────────────────────────────────────────  */
        scheme-toggler { display: none !important; } /* always dark — no toggler needed */
    </style>
</head>
<body>
